...
fn proof() -> Bool!String do
  ...
  create_account_export(request([Bytes.from_utf8(alice_path), Bytes.from_utf8("alice")],
    0,
    Bytes.empty())?)?
...
fn directory_answered(path :: String, encoded_profile :: Bytes) -> Result<(), String> do
  ...
  reconcile_prekeys_export(request([Bytes.from_utf8(path), acknowledgement], 0, Bytes.empty())?)?
  Ok(nil)
end
...
fn rotation() -> Bool!String do
  ...
  create_account_export(request([Bytes.from_utf8(carol_path), Bytes.from_utf8("carol")],
    0,
    Bytes.empty())?)?
  create_account_export(request([Bytes.from_utf8(dave_path), Bytes.from_utf8("dave")],
    0,
    Bytes.empty())?)?
  create_account_export(request([Bytes.from_utf8(erin_path), Bytes.from_utf8("erin")],
    0,
    Bytes.empty())?)?
  let bob_profile = create_account_export(request([
      Bytes.from_utf8(bob_path),
  ...
  published_last_resort(bob_path)?
