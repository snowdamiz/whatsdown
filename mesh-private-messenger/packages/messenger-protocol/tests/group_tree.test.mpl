...
fn proof() -> Bool!GroupTreeError do
  ...
  let updated = apply_update_path(second_tree,
    first_index,
    [
      path_node(31, 101, [second_index]),
      path_node(15, 102, [second_index]),
      path_node(7, 103, [second_index]),
      path_node(3, 104, [second_index]),
      path_node(1, 105, [second_index]),
      path_node(0, 106, [second_index])
    ])?
