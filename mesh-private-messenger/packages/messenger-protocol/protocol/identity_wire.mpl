...
pub fn encode_account_identity(value :: AccountIdentity) -> Bytes!ProtocolError do
  ...
  protocol_join([
      ...
      Bytes.from_utf8("ACT"),
      value.account_id,
      value.authorization_public_key,
      protocol_write_u64(value.created_at)?,
      protocol_write_u64(value.directory_sequence)?,
...
pub fn encode_device_credential(value :: DeviceCredential) -> Bytes!ProtocolError do
  ...
  protocol_join([
      ...
      value.dh_public_key,
      protocol_vector(value.post_quantum_public_key)?,
      protocol_write_u32(value.capabilities)?,
      protocol_write_u64(value.created_at)?,
