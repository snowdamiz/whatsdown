...
test('scheduled jobs survive failures and restarts, retain concurrent wakeups, and stop when idle', async () => {
  ...
  const options = convertV4MiniflareOptions({
    name: 'morse-job-test', compatibilityDate: '2026-09-18', compatibilityFlags: ['nodejs_compat'],
    modules: [
      ...
      { type: 'ESModule', path: 'witness.mjs', contents: await readFile(new URL('./witness.mjs', import.meta.url), 'utf8') },
