        ...
        AsyncFunction("invoke") { symbol: String, request: ByteArray ->
            synchronized(lock) {
                ...
                when (symbol) {
                    ...
                    "mesh_messenger_account_deletion" -> MeshLibrary.account_deletion_export(request)
                    "mesh_messenger_erase_account" -> MeshLibrary.erase_account_export(request)
                    "mesh_messenger_device_departure" -> MeshLibrary.device_departure_export(request)
                    "mesh_messenger_forget_on_proof" -> MeshLibrary.forget_on_proof_export(request)
